...
START_TEXT = (
    ...
    "1. Если необходимо узнать конкретную характеристику продукта, пишите мне "
    "«шнур OKB 792 PFX», «компрессор KNFF 80307 SI X» или вариации: "
    "«длина шнура OKB 792 PFX», «тип компрессора KNFF 80307 SI X». "
    "Можно не добавлять конкретный цвет модели — тогда я выгружу несколько полей сразу: "
    "например, «шнур OKB 792».\n\n"
    "2. Когда необходимо узнать все характеристики модели, указанные в карточке на сайте, "
    "достаточно написать «ттх и модель». Если написать модель без указания цвета, "
    "я выгружу несколько таких списков.\n\n"
    "3. Я могу дать ссылку на сайт. Напишите «ссылка и модель». "
    "Если указать модель без цвета, я выгружу несколько ссылок с похожим названием модели.\n\n"
