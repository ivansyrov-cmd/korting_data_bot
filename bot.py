...
START_TEXT = (
    ...
    "«OKB 792 PFX шнур» или наоборот «шнур OKB 792 PFX». "
    "Текст можно вписать максимально близкий к характеристике: "
    "«длина шнура», «тип компрессора». "
    "Если я не могу найти, то попробуй более близкий по смыслу, "
    "например «кабель OKB 792 PFX».\n\n"
    "2. <b>Все тех.характеристики модели одним списком:</b> «ттх и модель». "
    "Выдам полный список всего, что есть на сайте к этой модели. "
    "Если не указать цвет, то выгружу ТТХ нескольких моделей: «ттх KNFR».\n\n"
    "3. <b>Получить ссылку на сайт:</b> слово «ссылка», либо «сайт» + «модель».\n\n"
    "4. <b>Могу подсказать, в каких моделях схожая черта или технология, "
    "и выдать список.</b> "
